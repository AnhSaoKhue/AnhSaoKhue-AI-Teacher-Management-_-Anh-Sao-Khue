...
// Chuyen doi Tab giao dien
function switchTab(tabId) {
  // An tat ca cac View panel
  document.querySelectorAll('.tab-view').forEach(el => el.classList.add('hidden'));
  
  // Hien thi View panel duoc chon
  const targetView = document.getElementById('view-' + tabId);
  if (targetView) targetView.classList.remove('hidden');

  // Cap nhat style button Active
...
// Tạo nội dung giáo án chuẩn Công văn 5512
...
// Quay ngẫu nhiên chọn học sinh kiểm tra miệng
...
// Gửi tin nhắn tới trợ lý Miss Yến còi
...
// Tự động tạo giáo án mặc định khi mở ứng dụng
generateLesson();
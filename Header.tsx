...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
      ...
      {/* ========================================== */}
      <aside className="hidden md:flex flex-col w-68 bg-gradient-to-b from-blue-950 via-slate-900 to-blue-950 text-white fixed left-0 top-8 bottom-0 z-30 border-r border-blue-900/60 shadow-2xl">
        ...
        <div className="p-4 border-b border-blue-900/80 bg-gradient-to-br from-blue-900/60 via-slate-900 to-indigo-950/80">
          ...
          {/* Contact Box */}
          <div className="mt-2 bg-gradient-to-r from-blue-900/80 to-indigo-900/80 border border-cyan-400/30 rounded-xl p-2.5 text-center shadow-inner">

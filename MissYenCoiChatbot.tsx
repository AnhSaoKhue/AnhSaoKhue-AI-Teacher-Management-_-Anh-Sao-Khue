          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-slate-50 dark:bg-slate-950/50">
              {messages.map((msg) => (
                ...
                >
                  ...
                  <div
                    className={`max-w-[82%] rounded-2xl p-3 text-sm leading-relaxed shadow-sm ${
                      msg.sender === 'user'
            ...
            >
              <input
                ...
                disabled={isLoading}
                className="flex-1 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100 text-sm px-3.5 py-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button
                type="submit"
